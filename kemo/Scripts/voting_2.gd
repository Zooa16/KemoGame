...
func sync_global_teams(the_mission_team: Array, no_mission_team: Array):
    ...
    Global.no_mission_team = no_mission_team
    print("CLIENT/HOST: Teams synchronized. Mission Team: ", Global.the_mission_team, ", No Mission Team: ", Global.no_mission_team)
